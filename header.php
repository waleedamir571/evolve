...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="images/home/favicon.png">
    ...
    <div id="main-wrapper">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
                                    <div class="header-info">
										<span class="text-black">Ray chen</span>
       ...
       <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li class="">
                        <a class="" href="index.php">
							<img class="mb5" src="images/home/home.svg" alt="">
                    ...
                    <li class=""><a class="has-arrow ai-icon" href="my-assessment.php" aria-expanded="false">
							<img class="mb5" src="images/home/assessment.svg" alt="">
							<span class="nav-text">My Assessment</span>
						</a>
                      
                    </li>
                    <li class=""><a class="has-arrow ai-icon" href="notifications.php" aria-expanded="false">
							<img class="mb5" src="images/home/noti.svg" alt="">
							<span class="nav-text">Notification</span>
						</a>
                      
                    </li>
                    <li class=""><a class="has-arrow ai-icon" href="chat.php" aria-expanded="false">
							<img src="images/home/chat.png" alt="">
				...
				<!-- <div class="copyright">
					<p><strong> Dashboard</strong> © 2025 All Rights Reserved</p>
					<p>by text</p>
				</div> -->
			</div>
        </div>